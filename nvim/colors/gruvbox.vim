...
let s:gb.dark0       = ['#1c1c1c', 235]     " 40-40-40
...
" custom
let s:gb.dark_custom = ['#333333', 243]     
let s:gb.fg_dark_custom = ['#b3b3b3', 243]
...
let s:gb.bright_red     = ['#fb6150', 167]     " 251-73-52
...
if s:is_dark
  ...
  let s:fg7 = s:gb.fg_dark_custom " custom fg
...
call s:HL('StatusLine',   s:gb.dark_custom, s:fg7, s:inverse)
